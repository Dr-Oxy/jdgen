...
const Modal = ({ children, onClose }: ModalProp) => {
  return (
    <div className="h-full w-full ">
      <div className="z-[9999] h-[600px] w-full md:w-[420px] absolute bottom-0 lg:bottom-28  right-0 lg:right-32 px-6 pt-10 bg-[#F3F3F3] dark:bg-[#272727] border border-black dark:border-white md:rounded-3xl ">
        {/* modal header */}
        ...
        <div className="text-black absolute -bottom-6">
          <p className="text-xs">
            Powered by{' '}
            <span className="font-semibold">Renaissance Innovation Labs</span>{' '}
          </p>
        </div>
      </div>
